...
//                             // 單一
//                             $id = trim($parts[1]);
//                             $result = checkTask($DbConnection,$id);
...
//                         $reply = insertTask($DbConnection,$task_name,$task_description);
//                         break;
//                     case "修改":
...
//                                                 "type" => "postback",
//                                                 "label" => "修改事件名稱與描述",
//                                                 "data" => "action=set&key=update_task_content"
//                                             ],
//                                             [
//                                                 "type" => "postback",
//                                                 "label" => "修改事件開始與結束時間",
//                                                 "data" => "action=set&key=update_time"
//                                             ],
//                                         ]
//                                     ]
//                                 ],
...
//                                                         "type" => "datetimepicker",
//                                                         "label" => "開始時間",
//                                                         "data" => "action=set&key=start_time&task_id={$id}",
//                                                         "mode" => "datetime",
...
//                                                         "type" => "datetimepicker",
//                                                         "label" => "結束時間",
//                                                         "data" => "action=set&key=end_time&task_id={$id}",
//                                                         "mode" => "datetime",
...
require_once './function/Postgres.php';
$DbConnection       = DBConnectionHandler::getConnection();
